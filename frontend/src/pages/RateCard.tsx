        ...
        <Layout>
            <div className="flex-1 flex flex-col min-h-0 overflow-y-auto space-y-6 max-w-6xl w-full mx-auto">
                ...
                <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
                    <div className="md:col-span-1 card p-5 bg-gradient-to-br from-indigo-900 to-slate-900 text-white rounded-xl shadow-md flex flex-col justify-between relative overflow-hidden">
                        ...
                        <div>
                            <div className="flex items-center justify-between gap-2 mb-2">
                                ...
                                <span className="px-2 py-0.5 rounded-full bg-indigo-500/30 text-indigo-200 text-[10px] font-semibold border border-indigo-400/30">
                                    Global Fallback
                                </span>
                            </div>
                            ...
                            {editingBaseRate ? (
                                <div className="space-y-2 mt-2">
                                    <div className="relative">
                                        ...
                                        <input
                                            ...
                                            className="w-full bg-slate-800 border border-indigo-400 rounded-lg pl-7 pr-3 py-1.5 text-lg font-extrabold text-white focus:outline-none focus:ring-2 focus:ring-indigo-400"
                                            placeholder="85.00"
                                            autoFocus
                                        />
                                    </div>
                                    <div className="flex gap-2">
                                        <button
                                            ...
                                            className="px-3 py-1 bg-indigo-500 hover:bg-indigo-600 text-white text-xs font-bold rounded-md transition-colors flex items-center gap-1"
                                        >
                                ...
                                <div className="mt-1 flex items-baseline gap-2">
                                    ...
                                    <span className="text-xs text-indigo-300 font-medium">/ hour</span>
                                </div>
                            )}
                        </div>

                        <div className="pt-4 border-t border-indigo-800/60 mt-4 flex items-center justify-between">
                            <p className="text-[11px] text-indigo-200 leading-snug max-w-[200px]">
                    ...
                    <div className="md:col-span-2 card p-5 bg-white border border-slate-200 rounded-xl shadow-xs flex flex-col justify-between">
                        <div>
                            ...
                            <div className="grid grid-cols-1 sm:grid-cols-2 gap-3 text-xs">
                                ...
                                <div className="p-2.5 rounded-lg bg-indigo-50/70 border border-indigo-200">
                                    <span className="font-bold text-indigo-900 block mb-0.5">2. Default Base Rate</span>
                                    <span className="text-indigo-700/80 leading-normal">
                        ...
                        <div className="pt-3 mt-3 border-t border-slate-100 flex items-center gap-2 text-xs text-slate-500">
                            ...
                            <span>Worker roles can be updated anytime in the <a href="/members" className="text-indigo-600 font-semibold hover:underline">Members</a> tab.</span>
                        </div>
                    </div>
                </div>
                                ...
                                {rateCards.length === 0 ? (
                                    <tr>
                                        <td colSpan={4} className="px-5 py-10 text-center text-slate-400">
                                            ...
                                            <button
                                                onClick={handleOpenAddModal}
                                                className="mt-3 btn-primary text-xs py-1.5 px-3 inline-flex items-center gap-1"
                                            >
