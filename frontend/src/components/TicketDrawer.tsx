                    ...
                    {activeTab === 'data' && (
                        <div className="space-y-3">
                            ...
                            <div className="grid grid-cols-1 sm:grid-cols-2 gap-2.5">
                                ...
                                <div className="card p-2.5 bg-white border-2 border-slate-200 shadow-xs flex flex-col justify-between overflow-hidden">
                                    ...
                                    {allMedia.length > 0 ? (
                                        <div className="relative rounded-lg overflow-hidden border border-slate-200 bg-slate-900 aspect-4/3 flex items-center justify-center group">
                                            {allMedia[mediaSliderIndex]?.type === 'image' ? (
                                                ...
                                                <div className="w-full h-full p-2.5 bg-gradient-to-br from-indigo-950 to-slate-900 flex flex-col justify-center items-center text-center">
                                                    ...
                                                    <span className="text-[10px] font-bold text-indigo-200 mb-2">
                                            ...
                                            {allMedia.length > 1 && (
                                                <>
                                                    <button
                                                        ...
                                                        className="absolute left-1.5 top-1/2 -translate-y-1/2 p-1.5 rounded-full bg-black/70 hover:bg-black/90 text-white transition-colors cursor-pointer z-10"
                                                    ...
                                                    <button
                                                        ...
                                                        className="absolute right-1.5 top-1/2 -translate-y-1/2 p-1.5 rounded-full bg-black/70 hover:bg-black/90 text-white transition-colors cursor-pointer z-10"
                                                        title="Next Media"
                                                    >
                                        ...
                                        <div className="rounded-lg border-2 border-dashed border-slate-300 bg-slate-50 aspect-4/3 flex flex-col items-center justify-center text-slate-500 p-3 text-center">
                                ...
                                <div className="card p-3 bg-white border-2 border-indigo-200/90 shadow-xs flex flex-col justify-between">
                                    <div>
                                        <div className="flex items-center justify-between gap-1 mb-2 pb-1.5 border-b border-indigo-100">
                                            <div className="flex items-center gap-1.5 text-indigo-950 text-xs font-black uppercase tracking-wider">
                                                <Sparkles className="w-3.5 h-3.5 text-indigo-600" />
                                                AI Work Summary
                                            </div>
                                            {bucket.clarity_score !== null && bucket.clarity_score !== undefined && (
                                                <span className="text-[10px] font-extrabold text-emerald-800 bg-emerald-100 border border-emerald-300 px-2 py-0.2 rounded-full">
                                                    {Math.round(bucket.clarity_score * 100)}% Match
                                                </span>
                                            )}
                                        </div>
                                        <p className="text-[13px] text-slate-950 leading-relaxed font-semibold">
                                            {bucket.summary || bucket.raw_text || 'No summary available.'}
                                        </p>
                                    </div>

                                    <div className="pt-2 mt-2 border-t border-slate-200 flex items-center gap-1.5 flex-wrap">
                                        <span className="text-[10px] font-bold uppercase px-2 py-0.5 rounded bg-indigo-100 text-indigo-900 border border-indigo-300">
                            ...
                            <div className="card p-3.5 bg-white border-2 border-slate-200 shadow-xs space-y-3">
                                ...
                                <div className="grid grid-cols-2 gap-2.5 text-xs">
                                    ...
                                    <div className="p-2.5 bg-slate-50 rounded-lg border border-slate-200">
                                        <span className="text-[10px] font-bold text-slate-600 uppercase tracking-wider block mb-1">Project</span>
                                        <span className="font-black text-slate-950 truncate block text-[13px]">
                                    ...
                                    {/* Worker */}
                                    <div className="p-2.5 bg-slate-50 rounded-lg border border-slate-200">
                                        <span className="text-[10px] font-bold text-slate-600 uppercase tracking-wider block mb-1">Worker</span>
                                        <div className="flex items-center gap-1.5 font-black text-slate-950 truncate text-[13px]">
                                    ...
                                    <div className="p-2.5 bg-indigo-50/70 rounded-lg border border-indigo-200">
                                        <span className="text-[10px] font-bold text-indigo-800 uppercase tracking-wider block mb-1">Logged Hours</span>
                                        {onUpdateHours ? (
                                            <div className="flex items-center gap-1.5">
                                                <input
                                                    ...
                                                    className="w-18 px-2 py-0.5 text-xs font-black border-2 border-indigo-300 rounded bg-white text-indigo-950 focus:ring-2 focus:ring-indigo-500 focus:outline-none"
                                                    placeholder="0"
                                                />
                                                <span className="text-indigo-900 font-bold text-xs">hrs</span>
                                            </div>
                                        ) : (
                                    ...
                                    {/* Integrity Status */}
                                    <div className="p-2.5 bg-slate-50 rounded-lg border border-slate-200">
                                        <span className="text-[10px] font-bold text-slate-600 uppercase tracking-wider block mb-1">Audit Integrity</span>
                                        <span className={`inline-block px-2 py-0.5 rounded text-[10px] border ${integrity.color}`}>
                                            {integrity.label}
                                        </span>
                                    </div>
                                </div>
                                ...
                                <div className="pt-2 border-t border-slate-200 grid grid-cols-3 gap-2 text-center">
                                    <div className="p-2 bg-slate-100 rounded-lg border border-slate-200">
                                        <span className="text-[10px] font-bold text-slate-600 uppercase tracking-wider block">Rate</span>
                                        <span className="text-xs font-black text-slate-900">${rate}/hr</span>
                                    </div>
                                    <div className="p-2 bg-indigo-50 rounded-lg border border-indigo-200">
                                        <span className="text-[10px] font-bold text-indigo-800 uppercase tracking-wider block">Labor Cost</span>
                                        <span className="text-xs font-black text-indigo-950">
                                            ${laborCost.toFixed(2)}
                                        </span>
                                    </div>
                                    <div className="p-2 bg-emerald-50 border-2 border-emerald-300 rounded-lg">
                                        <span className="text-[10px] font-extrabold text-emerald-800 uppercase tracking-wider block">Billable Total</span>
